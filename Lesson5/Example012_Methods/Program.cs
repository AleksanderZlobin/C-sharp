...
//     }
// }
// Method21(msg: "текст", count: 4); // если именованные аргументы, можно не по порядку.
...
// Найти позицию минимального элемента в неотсортированной
// части массива.
// Произвести обмен этого значения со значением первой 
